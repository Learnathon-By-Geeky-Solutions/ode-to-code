...
void main() {
  ...
  testWidgets('SplashView displays logo and FadeTransition',
    ...
    expect(
        find.byWidgetPredicate(
          (widget) =>
              ...
              (widget.image as AssetImage).assetName == AssetsPath.appLogo2,
        ),
        findsOneWidget);
  });

  testWidgets('SplashView does not navigate automatically in test mode',
      (WidgetTester tester) async {
