...
void main() {
  ...
  testWidgets('ContentCard shows title, number and link',
  ...
  testWidgets('ContentCard shows note if link is not available',
      (WidgetTester tester) async {
    await tester.pumpWidget(createTestWidget(const ContentCard(
      number: '2',
      title: 'Chapter Notes',
  ...
  testWidgets(
      'ContentCard shows fallback text when neither link nor note is available',
      (WidgetTester tester) async {
    await tester.pumpWidget(createTestWidget(const ContentCard(
      number: '3',
      title: 'Empty Content',
